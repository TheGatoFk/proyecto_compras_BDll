...
// Consulta para obtener los productos de la categoría 10
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (95, 96, 97, 98, 99, 100, 101, 102, 103, 104)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Audio</h1>
            <h2 style="text-align: center;">Equipos y accesorios de sonido</h2>
        </div>
