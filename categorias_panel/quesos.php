...
// Consulta para obtener los productos de la categoría 5
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto In (5, 47, 48, 49, 50, 51, 52, 53, 54, 55)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Quesos</h1>
            <h2 style="text-align: center;">Quesos frescos y curados</h2>
        </div>
