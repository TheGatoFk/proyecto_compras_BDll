...
// Consulta para obtener los productos de la categoría 34
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (335,336,337,338,339,340,341,342,343,344)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Oficina</h1>
            <h2 style="text-align: center;">Artículos de oficina</h2>
        </div>
