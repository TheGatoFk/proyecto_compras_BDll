...
// Consulta para obtener los productos de la categoría 13
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (125,126,127,128,129,130,131,132,133,134)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Redes</h1>
            <h2 style="text-align: center;">Dispositivos de conectividad</h2>
        </div>
