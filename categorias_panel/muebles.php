...
// Consulta para obtener los productos de la categoría 26
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (255,256,257,258,259,260,261,262,263,264)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Muebles</h1>
            <h2 style="text-align: center;">Mobiliario para oficina</h2>
        </div>
