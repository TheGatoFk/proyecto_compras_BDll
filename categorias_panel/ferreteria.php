...
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (495,496,497,498,499,500,501,502,503,504)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Ferretería</h1>
            <h2 style="text-align: center;">Materiales de construcción</h2>
        </div>
