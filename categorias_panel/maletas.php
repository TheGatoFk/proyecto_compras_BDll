...
// Consulta para obtener los productos de la categoría 47
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (465,466,467,468,469,470,471,472,473,474)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Maletas</h1>
            <h2 style="text-align: center;">Bolsos y equipaje</h2>
        </div>
