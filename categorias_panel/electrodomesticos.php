...
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (65, 66, 67, 68, 69, 70, 71, 72, 73, 74)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Electrodomésticos</h1>
            <h2 style="text-align: center;">Aparatos eléctricos para el hogar</h2>
        </div>
