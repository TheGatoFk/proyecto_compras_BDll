...
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (325,326,327,328,329,330,331,332,333,334)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Smart Home</h1>
            <h2 style="text-align: center;">Dispositivos para hogar inteligente</h2>
        </div>
