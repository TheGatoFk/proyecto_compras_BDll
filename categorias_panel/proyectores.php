...
// Consulta para obtener los productos de la categoría 24
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (235,236,237,238,239,240,241,242,243,244)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Proyectores</h1>
            <h2 style="text-align: center;">Equipos de proyección</h2>
        </div>
