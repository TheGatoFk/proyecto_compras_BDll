...
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (1, 11, 12, 13, 14, 15, 16, 17, 18, 19)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Lácteos</h1>
            <h2 style="text-align: center;">Productos derivados de la leche</h2>
        </div>
