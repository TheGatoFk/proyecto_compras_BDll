...
// Consulta para obtener los productos de la categoría 21
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (205,206,207,208,209,210,211,212,213,214)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Componentes</h1>
            <h2 style="text-align: center;">Partes para PC</h2>
        </div>
