...
// Consulta para obtener los productos de la categoría 49
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (485,486,487,488,489,490,491,492,493,494)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Mascotas</h1>
            <h2 style="text-align: center;">Artículos para mascotas</h2>
        </div>
