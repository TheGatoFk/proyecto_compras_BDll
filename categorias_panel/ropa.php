...
// Consulta para obtener los productos de la categoría 44
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (435,436,437,438,439,440,441,442,443,444)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Ropa</h1>
            <h2 style="text-align: center;">Prendas de vestir</h2>
        </div>
