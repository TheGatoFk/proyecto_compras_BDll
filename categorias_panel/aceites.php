...
// Consulta para obtener los productos de la categoría 6
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (6, 56, 57, 58, 59, 60, 61, 62, 63, 64)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Aceites</h1>
            <h2 style="text-align: center;">Aceites comestibles</h2>
        </div>
