...
// Consulta para obtener los productos de la categoría 3
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (3, 29, 30, 31, 32, 33, 34, 35, 36, 37)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Cereales</h1>
            <h2 style="text-align: center;">Granos y cereales</h2>
        </div>
