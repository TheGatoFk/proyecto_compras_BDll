...
// Consulta para obtener los productos de la categoría 46
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (455,456,457,458,459,460,461,462,463,464)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Relojes</h1>
            <h2 style="text-align: center;">Relojes inteligentes y analógicos</h2>
        </div>
