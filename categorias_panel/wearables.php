...
// Consulta para obtener los productos de la categoría 16
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (155,156,157,158,159,160,161,162,163,164)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Wearables</h1>
            <h2 style="text-align: center;">Dispositivos vestibles</h2>
        </div>
