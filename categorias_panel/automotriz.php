...
// Consulta para obtener los productos de la categoría 35
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (345,346,347,348,349,350,351,352,353,354)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Automotriz</h1>
            <h2 style="text-align: center;">Accesorios para vehículos</h2>
        </div>
