...
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (75, 76, 77, 78, 79, 80, 81, 82, 83, 84)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Tecnología</h1>
            <h2 style="text-align: center;">Dispositivos electrónicos y gadgets</h2>
        </div>
