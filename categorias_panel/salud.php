...
// Consulta para obtener los productos de la categoría 40
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (395,396,397,398,399,400,401,402,403,404)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Salud</h1>
            <h2 style="text-align: center;">Artículos para el cuidado de la salud</h2>
        </div>
