...
// Consulta para obtener los productos de la categoría 15
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (145,146,147,148,149,150,151,152,153,154)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Tablets</h1>
            <h2 style="text-align: center;">Dispositivos tablet</h2>
        </div>
