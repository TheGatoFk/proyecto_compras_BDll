...
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (115,116,117,118,119,120,121,122,123,124)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Impresión</h1>
            <h2 style="text-align: center;">Equipos de impresión y escaneo</h2>
        </div>
