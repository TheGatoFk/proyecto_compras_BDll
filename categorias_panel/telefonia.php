...
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (315,316,317,318,319,320,321,322,323,324)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Telefonía</h1>
            <h2 style="text-align: center;">Teléfonos y accesorios</h2>
        </div>
