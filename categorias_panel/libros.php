...
// Consulta para obtener los productos de la categoría 43
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (425,426,427,428,429,430,431,432,433,434)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Libros</h1>
            <h2 style="text-align: center;">Libros y material educativo</h2>
        </div>
