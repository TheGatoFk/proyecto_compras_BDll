...
// Consulta para obtener los productos de la categoría 45
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (445,446,447,448,449,450,451,452,453,454)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Calzado</h1>
            <h2 style="text-align: center;">Zapatos y zapatillas</h2>
        </div>
