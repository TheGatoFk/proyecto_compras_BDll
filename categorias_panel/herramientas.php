...
// Consulta para obtener los productos de la categoría 25
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (245,246,247,248,249,250,251,252,253,254)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Herramientas</h1>
            <h2 style="text-align: center;">Herramientas eléctricas y manuales</h2>
        </div>
