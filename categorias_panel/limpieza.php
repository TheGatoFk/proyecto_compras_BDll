...
// Consulta para obtener los productos de la categoría 19
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (185,186,187,188,189,190,191,192,193,194)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Limpieza</h1>
            <h2 style="text-align: center;">Equipos de limpieza del hogar</h2>
        </div>
