...
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (85, 86, 87, 88, 89, 90, 91, 92, 93, 94)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Computación</h1>
            <h2 style="text-align: center;">Equipos y accesorios de computadora</h2>
        </div>
