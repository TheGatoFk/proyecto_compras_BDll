...
// Consulta para obtener los productos de la categoría 4
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (4, 38, 39, 40, 41, 42, 43, 44, 45, 46)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Huevos</h1>
            <h2 style="text-align: center;">Huevos de gallina y otros</h2>
        </div>
