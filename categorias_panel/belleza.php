...
// Consulta para obtener los productos de la categoría 39
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (385,386,387,388,389,390,391,392,393,394)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Belleza</h1>
            <h2 style="text-align: center;">Productos de cuidado personal</h2>
        </div>
