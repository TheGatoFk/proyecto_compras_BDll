...
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (165,166,167,168,169,170,171,172,173,174)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Fotografía</h1>
            <h2 style="text-align: center;">Cámaras y accesorios</h2>
        </div>
