...
// Consulta para obtener los productos de la categoría 38
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (375,376,377,378,379,380,381,382,383,384)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Viajes</h1>
            <h2 style="text-align: center;">Accesorios para viaje</h2>
        </div>
