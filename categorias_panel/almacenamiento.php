...
// Consulta para obtener los productos de la categoría 14
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (135,136,137,138,139,140,141,142,143,144)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Almacenamiento</h1>
            <h2 style="text-align: center;">Discos duros y unidades SSD</h2>
        </div>
