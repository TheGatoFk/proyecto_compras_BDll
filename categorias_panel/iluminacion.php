...
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (285,286,287,288,289,290,291,292,293,294)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Iluminación</h1>
            <h2 style="text-align: center;">Lámparas y luces</h2>
        </div>
