...
// Consulta para obtener los productos de la categoría 37
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (365,366,367,368,369,370,371,372,373,374)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Deportes</h1>
            <h2 style="text-align: center;">Artículos deportivos</h2>
        </div>
