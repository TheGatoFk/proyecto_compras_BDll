...
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (275,276,277,278,279,280,281,282,283,284)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Energía</h1>
            <h2 style="text-align: center;">Reguladores y baterías</h2>
        </div>
