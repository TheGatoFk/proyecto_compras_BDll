...
// Consulta para obtener los productos de la categoría 27
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.id_producto IN (265,266,267,268,269,270,271,272,273,274)";
...
<body>
    <div class="Contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: Accesorios</h1>
            <h2 style="text-align: center;">Complementos para dispositivos</h2>
        </div>
