...
// Consulta para obtener los productos de la categoría 12
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.categoria_id = 12"; // Cambiado a p.categoria_id
...
<head>
    ...
    <title><?php echo htmlspecialchars('Impresión'); ?></title>
</head>
<body>
    <div class="contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: <?php echo htmlspecialchars('Impresión'); ?></h1>
            <h2 style="text-align: center;"><?php echo htmlspecialchars('Equipos de impresión y escaneo'); ?></h2>
        </div>
