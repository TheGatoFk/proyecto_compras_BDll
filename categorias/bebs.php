...
// Consulta para obtener los productos de la categoría 48
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.categoria_id = 48"; // Cambiado a p.categoria_id
...
<head>
    ...
    <title><?php echo htmlspecialchars('Bebés'); ?></title>
</head>
<body>
    <div class="contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: <?php echo htmlspecialchars('Bebés'); ?></h1>
            <h2 style="text-align: center;"><?php echo htmlspecialchars('Productos para bebés'); ?></h2>
        </div>
