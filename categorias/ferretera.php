...
// Consulta para obtener los productos de la categoría 50
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.categoria_id = 50"; // Cambiado a p.categoria_id
...
<head>
    ...
    <title><?php echo htmlspecialchars('Ferretería'); ?></title>
</head>
<body>
    <div class="contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: <?php echo htmlspecialchars('Ferretería'); ?></h1>
            <h2 style="text-align: center;"><?php echo htmlspecialchars('Materiales de construcción'); ?></h2>
        </div>
