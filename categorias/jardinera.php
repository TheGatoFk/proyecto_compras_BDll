...
// Consulta para obtener los productos de la categoría 36
$query = "SELECT p.id_producto, p.nombre, p.descripcion, p.precio, p.stock, i.url_imagen 
          ...
          WHERE p.categoria_id = 36"; // Cambiado a p.categoria_id
...
<head>
    ...
    <title><?php echo htmlspecialchars('Jardinería'); ?></title>
</head>
<body>
    <div class="contenedor">
        ...
        <div class="titulo">
            <h1>Productos en la categoría: <?php echo htmlspecialchars('Jardinería'); ?></h1>
            <h2 style="text-align: center;"><?php echo htmlspecialchars('Herramientas para jardín'); ?></h2>
        </div>
